...
import com.jigneshpatel.notes.addnote.AddNoteActivity;
import com.jigneshpatel.notes.data.InMemoryNotesRepository;
import com.jigneshpatel.notes.data.Note;
import com.jigneshpatel.notes.data.NotesServiceApiImpl;
import com.jigneshpatel.notes.notedetail.NoteDetailActivity;
...
public class NotesFragment extends Fragment implements NotesContract.View {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mActionsListener = new NotesPresenter(new InMemoryNotesRepository(new NotesServiceApiImpl()), this);
